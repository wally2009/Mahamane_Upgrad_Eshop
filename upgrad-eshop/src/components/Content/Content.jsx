...
import SortProductFilter from '../../common/SortProductFilter';
import CategoryToggleFilter from '../../common/CategoryToggleFilter';
...
export const Filters = ({ isHideSort }) => {
    ...
    console.log("🚀 ~ file: Content.jsx:38 ~ Filters ~ productId:", productId)
    return (
        <div style={{ display: 'flex', marginTop: '16px' }}>
            <SortProductFilter isHide={isHideSort} />
            {!productId && <CategoryToggleFilter />}
